...
import { createUploadSession, refreshPartUrls, completeUpload, abortUpload, heartbeatUpload, resumeUpload } from "@/controllers/upload.controller";
...
router.get("/:sessionId/resume", partLimiter, resumeUpload);
